...
namespace Infrastructure.Persistence
{
    public class AppDbContext : DbContext
    {
        ...
        {
            //This to look for all entities configuration and apply them into the modelBuilder.
        ...
        //This override is to after saving changes then update/set the date for this action.
        public override Task<int> SaveChangesAsync(CancellationToken cancellationToken = new CancellationToken())
        {
            // Here we track all entities that inherite from AuditableEntity
            // And this class has the properties that I wanna set/update.
            foreach (var entry in ChangeTracker.Entries<AuditableEntity>())
            {
                switch (entry.State)
                {
                    case EntityState.Added: // If this action was add
